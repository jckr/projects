...
var variables=[
{key:"total", text: "A 100% MSA implies an undisturbed state. A decreaseing MSA value reflects increasing human pressure on ecosystems and a decline in intactness or naturalness. <strong>Click on the numbers below</strong> to see the contribution of different pressures on biodiversity."},
...
{key:"Nitrogen", text:"This represents the impact of <strong>nitrogen</strong> pollution (eg eutrophication and acidification)"},
...
svg.append("svg:text").text("Terrestrial MSA, %").attr("x","-350").attr("y","20").attr("transform","rotate(-90)");
