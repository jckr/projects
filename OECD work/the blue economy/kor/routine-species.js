...
var kText={anchovies:"멸치류",cod:"대구",mackerel:"고등어",salmon:"연어",sardines:"정어리",tuna:"참치"};
...
circles.append("title")
	.text(function(d) {return d.name+" - "+selectedK+": "+d3.format(",")(d.value[selected]);})
