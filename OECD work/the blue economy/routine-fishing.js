...
{text:
	{eng:"Iceland's position in the mid-North Atlantic has long made it a global fishing power. Dwindling cod stocks once jeopardized the fishing and processing industries, but they have since recovered and exports now top $3 billion annually.",
	 kor:"Iceland's position in the mid-North Atlantic has long made it a global fishing power. Dwindling cod stocks once jeopardized the fishing and processing industries, but they have since recovered and exports now top $3 billion annually."},
...
{text:
	{eng:"<br/><br/>",kor:"<br/><br/>"},
	countryLabel:{eng:"World",kor:"World"}
	,countries:[]}
];
...
d3.select("#population").on("click",function() {
	...
	d3.select("#legend").html("Population in thousands").classed("interface0-4",1).classed("interface0-5",0).classed("interface0-6",0);
...
d3.select("#production").on("click",function() {
	...
	d3.select("#legend").html("Fish production (thousands of tonnes)").classed("interface0-4",1).classed("interface0-5",0).classed("interface0-6",0);
...
d3.select("#consumption").on("click",function() {
	...
	d3.select("#legend").html("Fish consumption (thousands of tonnes)").classed("interface0-4",0).classed("interface0-5",0).classed("interface0-6",1);
