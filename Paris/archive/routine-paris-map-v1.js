...
function reinit(geoCheck,nodes,edges,stations) {
...
function repos(nodes,edges,stations, votes,s, dist) {
	...
	if(!s) {
		...
		backCircles.on("click",function() {repos(nodes,edges,stations)})
