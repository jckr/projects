...
svg.append("text").attr({x:850,y:20,id:"chapter"}).style("font-weight","bold").style("fill","white");
svg.append("text").attr({x:850,y:40,id:"POV"}).style("font-style","italic").style("fill","#eee");
